...
var tw = StyleSheet.create(_extends({}, styles, styles$1, style, styles$2, {
  hidden: {
    display: "none"
  }
}, styles$5, {
...
var buildComponent = function buildComponent(Component) {
  return function (_ref) {
    ...
    if (style) {
      ...
      var inline = StyleSheet.flatten([style].flat());
...
var View$1 = buildComponent(View);
var ScrollView$1 = buildComponent(ScrollView);
var Text$1 = buildComponent(Text);
var Image$1 = buildComponent(Image);
var TextInput$1 = buildComponent(TextInput);
var TouchableOpacity$1 = buildComponent(TouchableOpacity);

export { buildComponent, View$1 as View, ScrollView$1 as ScrollView, Text$1 as Text, Image$1 as Image, TextInput$1 as TextInput, TouchableOpacity$1 as TouchableOpacity };
